...
<div class="max-w-3xl mx-auto px-6 py-12">
    <div class="mb-8">
        ...
        <p class="text-slate-500 mt-2">
            Gestión de estudiantes del cliente Laravel.
        </p>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-slate-200 p-6 md:p-8">
        ...
        >
            ...
            <div class="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <a href="{{ route('students.index') }}" class="inline-flex items-center justify-center rounded-xl border border-slate-300 px-5 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 transition">
                    Volver al listado
                </a>
            </div>
        </form>
